...
const AGENTS = [
  ...
  { id: "AGENT_15", num: "15", name: "THE GROWTH INTELLIGENCE", role: "Market Expansion & IP", status: "scheduled", phase: 3, month: 7, mission: "Model revenue trajectory, scenario-plan for growth phases, and provide financial intelligence. All projections clearly labelled — not guarantees. Adl demands honest forecasting.", tools: ["Google Sheets","Notion","Claude/GPT-4","HubSpot Forecasting","Stripe Revenue","Looker Studio"], kpis: ["Monthly forecast accuracy ±15%","Annual model updated quarterly","3-scenario model maintained","Y1 target tracking £132K-£171K"], inbound: ["AGENT_08","AGENT_09"], outbound: ["AGENT_09"], ethics: false, checkpoints: ["Adl check — projections labelled as estimates"], escalation: ["Y1 target >30% at risk","Revenue concentration >40% single client","Cash flow operational risk"] }
];
...
const ETHICS = {
  sidq: { name: "Sidq", arabic: "صِدْق", meaning: "Truthfulness", icon: "S" },
  amanah: { name: "Amanah", arabic: "أَمَانَة", meaning: "Trustworthiness", icon: "A" },
  adl: { name: "'Adl", arabic: "عَدْل", meaning: "Justice", icon: "J" },
  grandfather: { name: "Grandfather Principle", arabic: "", meaning: "Loyalty Rewarded", icon: "G" }
};
...
const PHASES = [
  ...
  { id: 3, name: "Scale", months: "M7-9", label: "Optimise & Expand", focus: "Full ethics monitoring active. Revenue intelligence online. Founder's Circle launch. All systems optimised.", target: "£8K-£12K/mo", active: ["01","02","03","04","05","06","07","08","09","10","11","12","13","14","15"], color: "var(--purple)" },
  { id: 4, name: "Amplify", months: "M10-12", label: "Full Operational Capacity", focus: "All 15 agents fully operational. Year 1 target achievement (£132K-£171K). Year 2 planning commenced.", target: "£100K+ ARR", active: ["01","02","03","04","05","06","07","08","09","10","11","12","13","14","15"], color: "var(--amber)" }
];
